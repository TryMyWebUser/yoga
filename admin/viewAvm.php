                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $datas = Operations::getAVMS();
                                        if (!empty($datas)) {
                                            foreach ($datas as $data) {
                                    ?>
                                    <tr class="row-data" data-name="<?= $data['category']; ?>">
                                        <td><?= $data['category']; ?></td>
                                        <td><?= $data['at']; ?></td>
                                        <td><?= $data['ad']; ?></td>
                                        <td><?= $data['vt']; ?></td>
                                        ...
                                        <td>
                                            <div class="btn-list">
                                                <a href="editAvm.php?edit_id=<?= $data['id']; ?>"><button class="btn btn-sm btn-icon btn-success-light"><i class="ri-pencil-line"></i></button></a>
                                                <a href="deleteAvm.php?delete_id=<?= $data['id']; ?>"><button class="btn btn-sm btn-icon btn-danger-light"><i class="ri-delete-bin-line"></i></button></a>
                                            </div>
                                        </td>
                                    </tr>
